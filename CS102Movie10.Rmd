...
```{r 3}
URL <- 'https://www.imdb.com/title/tt0120737/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
for (page in 1:pages_to_scrape) {
  scraped_data <- Scrape_R(URL, Page_key)
...
```{r 9}
write.csv(DataFrame, file = "CS102Movie10.csv", row.names = FALSE)
```
